...
# ИСПРАВЛЕНО: Импортируем CommandStart для правильной обработки диплинков
...
# Вспомогательная функция, чтобы не дублировать код привязки БД для /start и /link
...
# ИСПРАВЛЕНО: Ловим команду /start. Если в ней есть аргумент (код из ссылки), привязываем аккаунт
...
# Оставляем ручной ввод на случай, если пользователь решит ввести команду сам
...
async def cmd_help(message: Message):
    # ИСПРАВЛЕНО: Сделали красивую и чистую разметку без кривых спецсимволов &lt;
    await message.answer(
